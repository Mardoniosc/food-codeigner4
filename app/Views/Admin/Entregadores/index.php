    ...
    <div class="card">
      <div class="card-body">
        ...
        <a href="<?php echo site_url("admin/entregadores/criar");?>"
          class="btn btn-primary btn-icon-text float-right mb-4"> <i class="mdi mdi-plus btn-icon-prepend"></i>
          Cadastrar </a>
            ...
            <tbody>
              ...
              <tr>
                <td class="py-1">
                  ...
                  <?php else:?>
                  <img src="<?php echo site_url('admin/images/entregador-sem-imagem.jpg');?>" alt="Card image cap">
                  <?php endif;?>
                </td>
                <td>
                ...
                <td>
                  <?php echo ($entregador->ativo && !$entregador->deletado_em) ?'<label class="badge badge-primary">Sim</label>' : '<label class="badge badge-danger">Não</label>'; ?>
                </td>
                ...
                <td>
                  ...
                  <a href="<?php echo site_url("admin/entregadores/desfazerexclusao/$entregador->id");?>"
                    class="badge badge-success ml-2"> <i class="mdi mdi-undo btn-icon-prepend"></i> Desfazer </a>
                  <?php endif; ?>
                </td>
