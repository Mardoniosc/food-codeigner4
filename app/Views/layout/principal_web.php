...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
  ...
  <div class="body-wrapper">
            ...
            <div class="item">
              <div class="carousel-caption">
                ...
                <div class="fadeUp fade-slow item_details">
                  ...
                  <p class="item_info">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
    ...
    <div class="container" style="margin-top: 2em;;">
      ...
      <?php if(session()->has('fraude')):?>
        ...
        <div class="alert alert-warning" role="alert">
          <strong>Atenção!</strong> <?php echo session('fraude');?>
        </div>
    ...
    <!-- Essa section renderizará os conteúdos especificos da view que estender esse lyout -->
            ...
            <div class="footer_content">
              <div class="row">
                <div class="col-sm-6 col-md-4">
                  ...
                  <p class="footer_txt">Lorem Ipsum is simply dummy text of the printing and typesetting industry. It
